SELECT DISTINCT tt1.*, tt2.team_name, tt2.pod_name from (WITH t1 AS (SELECT distinct date(creation_time, "Asia/Kolkata") dt, project_id, user_email, job_id, total_slot_ms,
