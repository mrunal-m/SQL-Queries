...
WITH
  ...
  SELECT
    ...
    CASE
        WHEN DATE(i.creation_time,"Asia/Kolkata")>=DATE_SUB(@run_date, INTERVAL 90 DAY) THEN 1
      ELSE
      0
...
upsert_stream_apply_watermark
  ...
  SELECT
    ...
    MAX(CASE
        WHEN DATE(creation_time,"Asia/Kolkata")>=DATE_SUB(@run_date, INTERVAL 90 DAY) THEN 1
      ELSE
      0
    END
  ...
  WHERE
    DATE(creation_time,"Asia/Kolkata")>=DATE_SUB(@run_date, INTERVAL 90 DAY)
  GROUP BY
    1,
    2,
    3 ),
