CREATE OR REPLACE TABLE `maximal-furnace-783.vibely_analytics.crmVibelyAdhocRetool_IPL_23Apr_prematch`
AS (
with a as (
...
'Power-hitters Clash! 💥' title, 'Video call and watch SRH vs MI tonight' text
...
WHERE date(a.time, "Asia/Kolkata") >= "2025-04-15" AND b.tenant = 'fz'
),
...
'feed' as target,
'adHoc' cohort,
'AdhocRetoolIPL_23Apr_prematch' as templateId,
a.title, 
a.text, 
a.thumbnailUrl, 
notifRank, 
