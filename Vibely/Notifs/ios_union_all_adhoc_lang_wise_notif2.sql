CREATE OR REPLACE TABLE `maximal-furnace-783.vibely_analytics.crmVibelyAdhocRetool_iosReclaimDAU4`
AS (
(with a as (
...
'tina patel wants to video call! 🤍' title, 'Call and talk now!' text,
...
'Divya Nair wants to video call! 🤍' title, 'Call and talk now!' text,
...
'Meenakshi wants to video call! 🤍' title, 'Call and talk now!' text,
...
'Tanvi wants to video call! 🤍' title, 'Call and talk now!' text,
...
'piya wants to video call! 🤍' title, 'Call and talk now!' text,
...
'priyanka wants to video call! 🤍' title, 'Call and talk now!' text,
...
'Prameela wants to video call! 🤍' title, 'Call and talk now!' text,
...
'Miki wants to video call! 🤍' title, 'Call and talk now!' text,
...
'Sumita Das wants to video call! 🤍' title, 'Call and talk now!' text,
...
'Tim Tim wants to video call! 🤍' title, 'Call and talk now!' text,
